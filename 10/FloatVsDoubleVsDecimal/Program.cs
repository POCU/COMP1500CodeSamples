...
namespace FloatVsDoubleVsDecimal
{
    class Program
    {
        ...
        {
            float[] floats = new float[] { 2.342f, 9.326f, 3.445f, 5.713f, 2.458f, 3.689f, 10.121f, 4.786f, 6.664f };

            float averageFloat = GetAverage(floats);

            Console.WriteLine($"Average in float: {averageFloat}");

            double[] doubles = new double[] { 2.342, 9.326, 3.445, 5.713, 2.458, 3.689, 10.121, 4.786, 6.664 };

            double averageDouble = GetAverage(doubles);

            Console.WriteLine($"Average in double: {averageDouble}");

            decimal[] decimals = new decimal[] { 2.342m, 9.326m, 3.445m, 5.713m, 2.458m, 3.689m, 10.121m, 4.786m, 6.664m };
